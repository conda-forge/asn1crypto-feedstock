About asn1crypto-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/asn1crypto-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=57&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/asn1crypto-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `asn1crypto` can be installed with `conda`:
...
```
mamba install asn1crypto
```

It is possible to list all of the versions of `asn1crypto` available on your platform with `conda`:
...
```
mamba search asn1crypto --channel conda-forge
```
...
mamba repoquery search asn1crypto --channel conda-forge

# List packages depending on `asn1crypto`:
mamba repoquery whoneeds asn1crypto --channel conda-forge

# List dependencies of `asn1crypto`:
mamba repoquery depends asn1crypto --channel conda-forge
```
